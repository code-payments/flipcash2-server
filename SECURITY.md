...
<a name="reporting"></a>
## Reporting security problems in the Flipcash Server

Please use this [Report a Vulnerability](https://github.com/code-payments/flipcash2-server/security/advisories/new) link.
